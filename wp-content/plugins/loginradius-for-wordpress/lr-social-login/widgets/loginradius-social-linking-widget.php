 ...
 */
class LoginRadius_Social_Linking_Widget extends WP_Widget {

    /**
     * Constructor for class LoginRadius_Social_Linking_Widget
     */
    function LoginRadius_Social_Linking_Widget() {
...
add_action( 'widgets_init', create_function( '', 'return register_widget ( "LoginRadius_Social_Linking_Widget" );' ) );
