	...
	class LR_Social_Login_Admin {
		...
		public function load_scripts( $hook ) {
			...
			if( $hook == 'loginradius_page_SocialLogin' || $hook == 'users.php') {
				...
				wp_enqueue_script( 'LoginRadius_options_page_script', LOGINRADIUS_PLUGIN_URL . 'assets/js/loginradius-options-page.js', array('jquery'), '1.0', $lr_js_in_footer );
				wp_enqueue_script( 'LoginRadius_options_page_script2', LOGINRADIUS_PLUGIN_URL . 'assets/js/loginRadiusAdmin.js', array('jquery', 'wp-color-picker'), '1.0', $lr_js_in_footer );
			}
					...
					<div class="stuffbox" style="width:60%; padding-bottom:10px">
						...
						<div class="inside" style='padding:0'>
							<table  class="form-table editcomment">
								...
								//echo LR_Common:: display_currently_connected_provider();
								?>
							</table>
						</div>
					</div>
